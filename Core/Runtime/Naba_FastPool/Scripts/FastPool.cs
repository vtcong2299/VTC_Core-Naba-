...
namespace NabaGame.Core.Runtime.Pool
{
    ...
    public class FastPool
    {
        ...
        /// </summary>
        [SerializeField] [Tooltip("Prefab that would be used as source")]
        ...
        /// </summary>
        [Tooltip(
            "Use custom pool ID. By default it equals to the InstanceID of the source prefab.\r\n[WARNING] Be careful with this option.")]
        [SerializeField]
        bool useCustomID = false;

        [SerializeField] [HideInInspector] int customID = -1;

        //helper variable to display count of cached objects by property drawer
        [SerializeField] [HideInInspector] int cached_internal;
        ...
        public FastPool(GameObject prefab, Transform rootTransform = null, bool warmOnLoad = true, int preloadCount = 0,
            int capacity = 0)
        {
            sourcePrefab = prefab;
        ...
        /// <param name="preloadCount">How much items must be cached at the start</param>
        /// <param name="capacity">Cache size (maximum amount of the cached items)  [0 - unlimited]</param>
        public FastPool(int id, GameObject prefab, Transform rootTransform = null, bool warmOnLoad = true,
        ...
        public bool Init(Transform rootTransform)
        {
            ...
            {
                cached_internal = 0;
                cache = new Stack<GameObject>(PreloadCount);
        ...
        {
            if (sceneObject != null /*&& !cache.Contains(sceneObject)*/)
            {
