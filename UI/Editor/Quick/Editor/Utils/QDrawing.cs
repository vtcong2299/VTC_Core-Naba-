...
// https://sassybot.com/blog/snippet-drawing-lines-in-editor-windows/
//
...
//Where pointA is the starting point of the line, and pointB is the end of the line.
//This will draw a straight line between those points.
//To draw a curved line like in the image at the top of this post you can either use the DrawBezierLine function of the above script, or use a function that’s built into Unity (which is what I use in the above picture).
    ...
    public class QDrawing
    {
                                          ...
                                          bool antiAlias, int segments)
        {
            ...
            for(int i = 1; i < segments; ++i)
            {
                ...
                QDrawing.DrawLine(lastV, v, color, width, antiAlias);
                lastV = v;
            }
        }
