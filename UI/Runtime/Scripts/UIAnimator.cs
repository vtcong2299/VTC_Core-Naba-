...
namespace Vtcong.Core
{
    public class UIAnimator
    {
        ...
        private static Vector3 GetTargetPosition(RectTransform target, Vector3 startPosition, Anim animation)
        {
            ...
            {
                case Core.Move.MoveDirection.Left: return new Vector3(-xOffset, startPosition.y, startPosition.z);
                case Core.Move.MoveDirection.Right: return new Vector3(xOffset, startPosition.y, startPosition.z);
                case Core.Move.MoveDirection.Top: return new Vector3(startPosition.x, yOffset, startPosition.z);
                case Core.Move.MoveDirection.Bottom: return new Vector3(startPosition.x, -yOffset, startPosition.z);
                case Core.Move.MoveDirection.TopLeft: return new Vector3(-xOffset, yOffset, startPosition.z);
                case Core.Move.MoveDirection.TopCenter: return new Vector3(0, yOffset, startPosition.z);
                case Core.Move.MoveDirection.TopRight: return new Vector3(xOffset, yOffset, startPosition.z);
                case Core.Move.MoveDirection.MiddleLeft: return new Vector3(-xOffset, 0, startPosition.z);
                case Core.Move.MoveDirection.MiddleCenter: return new Vector3(0, 0, startPosition.z);
                case Core.Move.MoveDirection.MiddleRight: return new Vector3(xOffset, 0, startPosition.z);
                case Core.Move.MoveDirection.BottomLeft: return new Vector3(-xOffset, -yOffset, startPosition.z);
                case Core.Move.MoveDirection.BottomCenter: return new Vector3(0, -yOffset, startPosition.z);
                case Core.Move.MoveDirection.BottomRight: return new Vector3(xOffset, -yOffset, startPosition.z);
                case Core.Move.MoveDirection.CustomPosition: return animation.move.customPosition;
