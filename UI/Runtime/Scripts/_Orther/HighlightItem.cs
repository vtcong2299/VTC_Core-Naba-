...
namespace Vtcong.Core
{
    ...
    public class HighlightItem : UIBehaviour, IMaterialModifier
    {
        [SerializeField] private bool showGraphics = true;

        [NonSerialized] private Graphic _graphic;

        [NonSerialized] private Material _highlightMaterial;
