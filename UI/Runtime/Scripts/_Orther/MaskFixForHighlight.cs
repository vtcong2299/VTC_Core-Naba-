...
namespace Vtcong.Core
{
    ...
    public class MaskFixForHighlight : UIBehaviour, IMaterialModifier
    {
        [NonSerialized] private Graphic _graphic;

        [NonSerialized] private Mask _mask;

        [NonSerialized] private Material _maskMaterial;

        [NonSerialized] private Material _unmaskMaterial;
